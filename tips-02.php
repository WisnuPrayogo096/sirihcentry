      ...
      <div class="col-lg-8">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text" style="text-align: justify;">
            <strong>1. Pengaturan Perangkat Keras (Hardware Setup):</strong>
            <ul>
              <li>Hubungkan sensor kelembapan tanah ke ESP32. Pastikan Anda menggunakan pin yang sesuai untuk koneksi sensor ke papan ESP32.</li>
            ...
            <p class="card-text" style="text-align: justify;">
            <strong>5. Monitoring dan Analisis (Monitoring and Analysis):</strong>
            <ul>
